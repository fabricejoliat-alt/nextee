...
export default function EventCriteriaSelector({ clubId, eventType, selectedIds, onChange, disabled }: Props) {
  ...
  return <div style={{ display: "grid", gap: 12, padding: 14, border: "1px solid rgba(0,0,0,.1)", borderRadius: 12, background: "rgba(255,255,255,.7)" }}>
    <div><b style={{ fontSize: 13 }}>Focus de l’activité ({selectedIds.length}/3)</b><p style={{ margin: "4px 0 0", fontSize: 11, opacity: .65 }}>Choisissez jusqu’à trois priorités personnalisées. Seuls les critères cochés seront ajoutés à cette activité, en plus des six critères standards.</p></div>
