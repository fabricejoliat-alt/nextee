-- Fix OM for 18-hole competitions played on a 9-hole course twice (2 x 9).
-- In that case the stored tee Course Rating often corresponds to a single 9-hole
-- tee. OM must use the 18-hole equivalent Course Rating to avoid artificially
