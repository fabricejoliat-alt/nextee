-- Delete all message threads linked to a group before any group membership rows.
-- This avoids downstream sync logic from touching group-linked threads during delete.
