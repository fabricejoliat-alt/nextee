          ...
          <div className="marketplace-header">
            ...
            <div className="marketplace-actions" style={{ marginTop: 2 }}>
              ...
              <Link
                ...
                href={`/manager/groups/${groupId}/planning/${eventId}/players/${playerId}/edit`}
              >
            ...
            {loading ? (
              ...
              <div style={{ display: "grid", gap: 14 }}>
                ...
                <div style={{ display: "grid", gap: 8 }}>
                  <div style={{ fontSize: 12, fontWeight: 950, color: "rgba(0,0,0,0.75)" }}>Training structure (sections)</div>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, flexWrap: "wrap" }}>
                  ...
                  <Link className="btn" href={`/manager/groups/${groupId}/planning/${eventId}/players/${playerId}/edit`}>
                    Évaluer
                  </Link>
                </div>
              </div>
